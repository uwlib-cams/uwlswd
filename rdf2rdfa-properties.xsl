...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xml="http://www.w3.org/XML/1998/namespace" xmlns:ldproc="https://doi.org/10.6069/uwlib.55.b.2#"
    version="2.0">
    
    <xsl:variable name="name">University of Washington Libraries rdfs:Property definitions</xsl:variable>
    <xsl:variable name="base">https://www.lib.washington.edu/static/public/cams/data/localResources/</xsl:variable>
    <xsl:variable name="filename">properties_local</xsl:variable>
        ...
        <html xmlns="http://www.w3.org/1999/xhtml" version="XHTML+RDFa 1.1"
            ...
            <head>
                ...
                <script type="application/ld+json">
                    ...
                    "@type" : "Dataset" ,
                    "@id" : "https://doi.org/10.6069/uwlib.55.d.3" ,
                    "creator" : {
                    "@type" : "Organization" ,
                    ...
                    "name" : "University of Washington Libraries rdfs:Property definitions" ,
                    "alternateName" : "Local classes, University of Washington Libraries" ,
                    "description" : "Properties used in University of Washington Libraries RDF data." ,
                    "publisher" : {
                    "@type" : "Organization" ,
                    "name" : "University of Washington Libraries" ,
                    "url" : "http://www.lib.washington.edu/" ,
