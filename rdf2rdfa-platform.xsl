...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- Info about dataset -->
    <!-- Title of dataset -->
    <xsl:variable name="datasetName">Linked Data Platforms</xsl:variable>
    <xsl:variable name="currentPartDoi">https://doi.org/10.6069/uwlib.55.d.2</xsl:variable>
    <xsl:variable name="nameVersion">classes_local-1-0-0</xsl:variable>
    <xsl:variable name="description">Platforms (or applications) used to process RDF datasets.</xsl:variable>

    <!-- Filepath for generating links to serializations (path *up to filename*) -->
    <xsl:variable name="path">https://www.lib.washington.edu/static/public/cams/data/localResources/</xsl:variable>
        ...
        <html xmlns="http://www.w3.org/1999/xhtml" version="XHTML+RDFa 1.1"
            ...
            <head>
                ...
                <script type="application/ld+json">
                    ...
                    "@type" : "Dataset" ,
                    "@id" : "https://doi.org/10.6069/uwlib.55.d.2" ,
                    "creator" : {
                    "@type" : "Organization" ,
                    ...
                    "name" : "Linked Data Platforms" ,
                    "description" : "Platforms (or applications) used to process RDF datasets." ,
                    "publisher" : {
                    "@type" : "Organization" ,
                    "name" : "University of Washington Libraries" ,
                    "url" : "http://www.lib.washington.edu/" ,
