...
<xsl:stylesheet 
    ...
    <!-- vars from Theo's props transform -->
    <xsl:variable name="name">University of Washington Libraries RDA Application Profile Extension</xsl:variable>
    ...
    <xsl:variable name="hrefBase" select="concat($base,$filename,'-',$version)"/>
    ...
    <!-- XHTML+RDFa output -->
        <html xmlns="http://www.w3.org/1999/xhtml" version="XHTML+RDFa 1.1"
            ...
            <!-- "prefix" above... I dont understand these. I thought that in the output, rdf:RDF > xmlns:xx="http://yy", etc., provided prefix values -->
            <head>
                <title>
                    <xsl:value-of select="$name"/>
                </title>
                <!-- 2019-11-13: Not taking the time to incorporate schemaOrgMarkup.xsl here today, instead hard-coding schema markup -->
                <script type="application/ld+json">
                    ...
                    "name" : "University of Washington Libraries RDA Application Profile Extension" ,
                    "description" : "RDF dataset describing properties required beyond those provided by the RDA Registry to describe RDA Entities at University of Washington Libraries." ,
                    "publisher" : {
                    "@type" : "Organization" ,
                    "name" : "University of Washington Libraries" ,
                    "url" : "http://www.lib.washington.edu/" ,
            ...
            <!-- (BR) I'm curious about the use of RDFa about in the body element below... No "property" or "resource" attrs follow this one to create an overall triple for the body element? -->
            <body about="https://doi.org/10.6069/uwlib.55.d.4">
                <h1>
                    <xsl:value-of select="$name"/>
                </h1>
                <p>The RDF dataset below describes properties required beyond those provided by the RDA Registry to describe RDA Entities at University of Washington Libraries.</p>
