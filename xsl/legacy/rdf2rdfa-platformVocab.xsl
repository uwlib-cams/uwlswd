...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- Info about dataset -->
    <!-- Title of dataset -->
    <xsl:variable name="datasetName">Linked Data Platform Vocabulary</xsl:variable>
    <xsl:variable name="currentPartDoi">https://doi.org/10.6069/uwlib.55.b.1</xsl:variable>
    <xsl:variable name="nameVersion">platformVocab-1-0-0</xsl:variable>
    <xsl:variable name="description">RDFS vocabulary establishing classes and properties needed to describe platforms used to process RDF datasets. The word platforms represents applications, software, scripts, programs, etc. useful in processing the datasets.</xsl:variable>
        ...
        <html xmlns="http://www.w3.org/1999/xhtml" version="XHTML+RDFa 1.1"
            ...
            <head>
                ...
                <script type="application/ld+json">
                    ...
                    "name" : "Linked Data Platform Vocabulary" ,
                    "description" : "RDFS vocabulary establishing classes and properties needed to describe platforms used to process RDF datasets. The word platforms represents applications, software, scripts, programs, etc. useful in processing the datasets." ,
